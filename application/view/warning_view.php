...
<div class="container" id="mainBox">	
	...
	if (isset($_GET['action'])) {
		if($_GET['action']==='hasaccount'){
			$auth = '<h3><div id="thanx" class="alert alert-danger" role="alert"> ACCOUNT IS NOT AVAILABLE. </div></h3>
					<div class="container-fluid" id="shop_more_btn_div">
						<a href="../view/create_account_view.php" class="btn btn-primary" id="shop_more_btn">SIGN IN AGAIN</a>
					</div>';
		}
